  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="zoom-in-left")
      .titulo-principal__numero
        span 2
      h1 Negociación y acuerdos comerciales
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-7.my-3 
        .cajon.color-acento-contenido.p-4.mb-4(data-aos="flip-down")
          p(data-aos="fade-down").mb-0 No obstante, si el proceso de negociación se rompe y no se puede llegar a un acuerdo, hay que volver a programar una nueva reunión.  Así se evita que todas las partes se involucren en situaciones acaloradas o discusiones, que no solo hacen perder tiempo, sino que pueden dañar las relaciones futuras. En la siguiente reunión, deben repetirse las etapas de la negociación. Hay que tener en cuenta las nuevas ideas o intereses y volver a analizar la situación. En esta fase también puede ser útil buscar otras soluciones alternativas o traer a otra persona para que medie.
      .col-lg-5.my-3
    ...
    TabsA.color-acento-botones.my-5(data-aos="fade-left")  
      .tarjeta.color-acento-botones--borde.p-4(titulo="Oferta / propuesta")
        .row.justify-content-center.align-items-start
          .col-lg-4.my-3
            img.img-a.img-t(src='@/assets/curso/temas/15.png', alt='')
          .col-lg-8.my-3
            p La oferta hecha por el oferente debe ser clara, es decir, los términos relativos a la oferta deben ser ciertos. Además, la oferta debe ser comunicada al destinatario, y se considera completa cuando este la conoce.    
      .tarjeta.color-acento-botones--borde.p-4(titulo="Aceptación")
        .row.justify-content-center.align-items-start
          .col-lg-4.my-3
    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta bg6")
      ...
      .row.justify-content-center.align-items-start(titulo="Contrato")
        .col-lg-7.my-3
          p.mb-0 Su principal ventaja es que detalla los términos específicos que las partes contratantes han acordado, y cuando una o más partes no cumplen con sus obligaciones, sirve de guía para que un tribunal de justicia determine la reparación adecuada para la parte o partes perjudicadas. Incluso cuando las partes tienen una buena relación y confían unas en otras, el uso de un contrato proporciona una capa adicional de garantía de que las obligaciones contraídas en virtud del contrato se cumplirán tal y como las propias partes pretendían. Los contratos suelen ser más aconsejables que los acuerdos en cualquier asunto oficial, de negocios o comercial, debido a la protección añadida que proporcionan.
        .col-lg-4.my-3
